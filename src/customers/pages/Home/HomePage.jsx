...
dispatch(getAllRestaurantsAction(localStorage.getItem("jwt")))
  ...
  <p className="text-2xl lg:text-7xl font-bold z-10 py-5" style={{ fontFamily: 'cursive' }}>
    Soni Foods
  </p>
  <p className="z-10 text-gray-300 text-xl lg:text-4xl" style={{ fontFamily: 'cursive' }}>
    Discover Delicious
  </p>
</div>
